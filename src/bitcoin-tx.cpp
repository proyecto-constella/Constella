...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " constella-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  constella-tx [options] <hex-tx> [commands]  Update hex-encoded constella transaction\n" +
            "or:     constella-tx [options] -create [commands]   Create hex-encoded constella transaction\n" +
            "\n";
