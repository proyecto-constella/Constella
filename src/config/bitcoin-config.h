...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Constella Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Constella Core"
...
#define PACKAGE_BUGREPORT "https://github.com/constella-project/constella/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Constella Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Constella Core 0.18.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "constella"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://constella.org/"
