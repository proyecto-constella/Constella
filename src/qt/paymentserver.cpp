...
const char* BIP71_MIMETYPE_PAYMENT = "application/constella-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/constella-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/constella-paymentrequest";
#endif
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("constella://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'constella://' is not a valid URI. Use 'constella:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Constella address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
