Constella Core version *0.15.1* is now available from:

  <https://download.constella.org/constella-0.15.1/>
...
A number of changes to the way Constella Core deals with peer connections and invalid blocks
