# Support for Output Descriptors in Constella Core

Since Constella Core v0.17, there is support for Output Descriptors. This is a
...
on Constella's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Constella Core wallets, a convenience function `combo` is
