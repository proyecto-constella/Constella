...
"""Verify that starting constella with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start constella with -h for help text")
        ...
        self.log.info("Start constella with -version for version information")
        ...
        self.log.info("Start constellad with -fakearg to make sure it does not start")
